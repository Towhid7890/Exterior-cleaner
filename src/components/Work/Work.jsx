...
const Work = () => {
    return (
        <div className="mt-12 py-5">
            ...
            <h2 className="text-3xl text-primary font-bold text-center">MVP Exterior Cleaning's Commitment to Excellence</h2>
            <div className="grid grid-cols-4 w-[90%] mx-auto gap-1 mt-16">
